                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <textarea class="form-control col-md-8" name="product_desc" id="product_desc"><?php if(isset($product)){echo $product->product_desc;}else{echo '';}?></textarea>
                                        </div>
                                                ...
                                                <div class="row" >
                                                    <div class="col-md-6" >
                                                        <div class="form-group row" id="div_vn">
                                                            ...
                                                            <input type="text" class="form-control col-md-8" name="varient_name[]" id="varient_name" value="<?php echo $pd->varient_name; ?>">
                                                        </div>
                                            ...
                                            <div id="innervd" class="innervd" style="border-color: black; border: 1px solid; padding :15px; margin-top: 10px;">
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-md-3">Barcode</label> 
                                                            <input type="text" class="form-control col-md-8" name="barcode[]" id="barcode" >
                                                        </div>
...
<script type="text/javascript">
    ...
    /*function radiocheck()
    {
        var pv = $("input[name='product_varient']:checked").val();
        if(pv == 0)
        {
            $("#lblvddetail").hide();
            $("#lblpsdetail").show();
