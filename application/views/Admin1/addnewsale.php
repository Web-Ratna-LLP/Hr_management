                                        ...
                                        <div class="form-group">
                                            ...
                                            <Select class="form-control select2" id="product_detail_id" name="product_detail_id">
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                ?>
                                                    <option value="<?php echo $product->product_detail_id;?>"><?php echo $product->product_name;?>-<?php echo $product->varient_name; ?>-<?php echo $product->barcode; ?></option>
                                                <?php
                                                    } 
                                                ?>  
                                            </Select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" id="saleid" value="">
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-md-3"></label>
                                            <input type="text" id="shopid" value="">
                                        </div>
                                    </div>                              
...
<script type="text/javascript">
    ...
    function fetchserialdetail(pid=null,ser_no=null)
    {
        $.ajax({
            url : "<?php echo base_url()?>index.php/Admin/fetchserialdetail",
            type : "post",
            data : {pid : pid,ser_no:ser_no},
            success : function(data)
            {
    ...
    function calculate1(total)
    {
        ...
        if(discount > 0)
        {
            disamt = ((price * discount) / 100);
        
            if(tax_id > 0)
            {
                tax_amt = (((price - disamt) * tax_id) / 100);
            }
        }
        else
        {
            if(tax_id > 0)
            {
                tax_amt = ((price * tax_id) / 100);
            }
        }

        total = price + tax_amt - disamt;
        
        //total_amt = subtotal + tax_amt - disamt;
        $('#total').val(total.toFixed(2));
        $('#tax_amt').val(tax_amt.toFixed(2));
    }
