...
<body>
	<div class="invoice-box row" > 
	   <input type="button" name="print" value="Export" onclick="print()">
	...
	<div class="invoice-box" id="printDiv" style="min-height:942px;">		
		...
		<div class="borderSolid" style="border: 1px solid;"> 
			...
			<table>
		            ...
		            <table>
		              <tr>
		                <td colspan="4" class="information col-md-8">
		                  <table>
		                      <tr>
		                        <td class="bold col-md-2">User </td> <td>:</td> <td class="otDetail col-md-10"><?php if($sale){ echo $sale->customer_name; }else{ echo ""; }  ?></td>
		                      </tr>
		                      <tr>
                                <td class="bold col-md-2" >Address </td> <td>:</td><td class="otDetail col-md-10"><?php echo $sale->customer_address; ?></td>
		                      </tr>
		                      <tr>
		                        <td class="bold col-md-2">Mobile No </td> <td>:</td> <td class="otDetail col-md-10"><?php echo $sale->customer_mobile; ?></td>
		                      </tr>
		                  </table>
		                </td>
		                <td colspan="4" class="details col-md-4">
		                    <table>
		                        <tr class="details">
		                          <td class="bold col-md-6">Invoice No </td> <td>:</td><td class="otDetail col-md-6" id="collectionno"><?php echo $sale->invoice_string; ?></td>
		                        </tr>
		                        <tr class="details">
		                          <td class="bold col-md-6">Invoice Date </td> <td>:</td><td class="otDetail col-md-6"><?php echo date("d/m/Y", strtotime($sale->invoice_date)); ?></td>
		                        </tr>			         
		                        <tr>
		                          <td ></td><td></td>
		                        </tr>
				...
				<br>
		        <tr>
		          <td colspan="8" style="border: 1px solid #eee; ">
		            <table >
		                <tr class="heading">
		                    <td><b>Sr</b></td>
            ...
            <center><h4>Computer Generated Bill</h4></center>
		</div>
	</div>
</body>
