            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="" action="<?php echo base_url()?>index.php/Admin/attendanceInsert" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <Select class="form-control col-md-7" id="name" name="name">
                                    ...
                                    <?php
                                                    ...
                                                    {
                                                ?>
                                    <option value="<?php echo $customer->m_name;?>"><?php echo $customer->m_name; ?>
                                    </option>
                                    <?php
                                                    } 
                                                ?>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td><a style="color:blue;" value="<?php echo $brand->attendance_id;?>"
                                            onclick="btneditbrand(this)"><i class="fa fa-edit"></i></a></td> -->
                                    <td><a style="color:red;" value="<?php echo $brand->attendance_id;?>"
...
function btndeletebrand(e) {
    var attendance_id = $(e).attr('value');
