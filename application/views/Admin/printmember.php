...
<body><br><br>
	<div class="btn" style="margin: 25px 61px;" > 
	    ...
	    <a class="btn btn-info" href="<?php echo base_url()?>index.php/Admin/payment">Back</a>
		              ...
		              <tr >
		                <td colspan="4" class="information col-md-8" >
		                  <table>
                              ...
                              <tr>
                                  <td class="bold col-md-10">Name:-  <?php if($member){ echo $member->m_name; }else{ echo ""; }  ?></td>
                              </tr>
		                      <tr>
                                <td class="bold col-md-10">Address:- <?php echo $member->address; ?><br>Mo Number:- <?php echo $member->number; ?></td>
		                      </tr>
		                  </table>
                        </td>
		            ...
		            <table style="border-bottom: 1px solid; ">
                        ...
                        ?>
    	                    <tr class="item">
    	                        ...
    	                        <td><?php echo $member->rate; ?></td>
    	                        <td><?php echo $member->due_rate;?></td>
                                <td><?php echo $member->pay_rate;?></td>
                        ...
                        <tr class="item last">
                            ...
                            <td><b><?php echo $member->rate; ?></b></td>
					...
					<td colspan="8">
				      <table>
				        <tr class="AmtWords">
				          ...
				          <td colspan="7"><script type="text/javascript">document.write( number2text('<?php echo $member->pay_rate; ?>'));</script> </td>
				        </tr>
				      </table> 
					</td>
				</tr>
