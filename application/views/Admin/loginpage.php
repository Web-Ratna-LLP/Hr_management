        ...
        <div class="wrapper-page">
            <div class="card overflow-hidden account-card mx-3">
                <div class="bg-primary p-4 text-white text-center position-relative">
                    ...
                    <p class="text-white-50 mb-4">Sign in to continue to Hr Management System.</p>
            ...
            <div class="m-t-40 text-center">
                ...
                <p>© 2021 Hr Management System. Crafted with <i class="mdi mdi-heart text-danger"></i> by Web Ratna</p>
            </div>
        </div>
        <!-- end wrapper-page -->
        <!-- jQuery  -->
